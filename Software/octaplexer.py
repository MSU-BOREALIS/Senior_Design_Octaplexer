...
clock = 21							#if high data will be read
PIL   = 20							#specifies the mode that the data is for
PIH   = 26							#specifies the mode that the data is for
...
######################################################################################################	
	...
	time.sleep(1)		#this is to give the processor plenty of time to read the data in
	if(mode == 01):
		time.sleep(9)
